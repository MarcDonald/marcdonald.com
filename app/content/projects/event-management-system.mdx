...
description: 'Final year project for my BEng Software Engineering degree.'
link: https://github.com/MarcDonald/event-management-system
...
<Alert>
	...
	<AlertDescription>
		This project was created as a university project and is not suitable for
		production. There will be no active development on this project.
	</AlertDescription>
</Alert>

A system for the management of Security and Stewarding staff at events created as a final year project for my BEng
Software Engineering degree. For this project and accompanying dissertation I was awarded 80%. Video demonstration is
available [here](https://www.youtube.com/watch?v=I06jotU_4uA).
...
- An [Android app](https://github.com/MarcDonald/event-management-system/tree/master/android-app/) for Stewards to request assistance from the control room

- A [web dashboard](https://github.com/MarcDonald/event-management-system/tree/master/web-app/) for Control Room Operators to view assistance requests for events, and for Admins to
  manage Events, Venues, and Staff

- A serverless AWS [backend](https://github.com/MarcDonald/event-management-system/tree/master/cdk-stack/)
...
<div className={'mx-auto my-4 md:w-3/4'}>
	<img
		src="https://raw.githubusercontent.com/MarcDonald/event-management-system/master/.github/assets/architecture.png"
...
request the metadata would be “assistanceRequest_UUID”. To assist retrieval of specific types of data I created a
...
<div className={'mx-auto my-4'}>
	<img
		src="https://raw.githubusercontent.com/MarcDonald/event-management-system/master/.github/assets/example-data.png"
		alt="Example Data"
		className={'mx-auto aspect-video rounded-md object-contain'}
	/>
</div>
...
<div className={'mx-auto my-4 md:w-3/4'}>
	<img
		src="https://raw.githubusercontent.com/MarcDonald/event-management-system/master/.github/assets/rest-api.png"
		alt="Rest API Schema"
		className={'mx-auto aspect-video rounded-md object-contain'}
	/>
</div>
...
<div className={'mx-auto my-4 md:w-3/4'}>
	<img
		src="https://raw.githubusercontent.com/MarcDonald/event-management-system/master/.github/assets/websocket-flow.png"
		alt="WebSocket Flow"
		className={'mx-auto aspect-video rounded-md object-contain'}
	/>
</div>
