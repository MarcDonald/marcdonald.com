...
This takes a significant chunk of time and energy, because let's be honest no-one signed up for this amount of
...
feature so we could automatically send PRs that are relevant to our team directly to a Slack channel - but I found
that this alone wasn't enough. I was still clicking into PRs constantly to see if I had approved them in the past,
...
You can try it out for yourself at [omniscience.app](https://omniscience.app) or on the
[App Store](https://apps.apple.com/gb/app/omniscience-for-github/id6467049481?mt=12).

<div className={'mx-auto my-4 block dark:hidden md:w-3/4'}>
	<img
...
<div className={'mx-auto my-4 hidden dark:block md:w-3/4'}>
	<img
