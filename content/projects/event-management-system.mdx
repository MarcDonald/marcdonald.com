...
<Alert>
    ...
    <AlertDescription>
        This project was created as a university project and is not suitable for production. There will be no active
        development
        on this project.
    </AlertDescription>
</Alert>
...
![Architecture Diagram](https://raw.githubusercontent.com/MarcDonald/event-management-system/master/.github/assets/architecture.png)
...
![Example Data](https://raw.githubusercontent.com/MarcDonald/event-management-system/master/.github/assets/example-data.png)
...
![API Schema](https://raw.githubusercontent.com/MarcDonald/event-management-system/master/.github/assets/rest-api.png)

### Generic WebSocket Lambda Flow

![WebSocket Flow](https://raw.githubusercontent.com/MarcDonald/event-management-system/master/.github/assets/websocket-flow.png)
